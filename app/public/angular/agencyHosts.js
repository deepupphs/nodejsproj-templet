...
app.factory("A_dashboardFactory", function ($http, $window) {
  return {
    assignUserDetails: function (userID) {
      url = baseAddress + "agency/assign-host" + "/" + userID;
      return $http.put(url);
    },
    addUserDetails: function (data) {
      url = baseAddress + "agency/add-host";
    ...
    getSingleDetails: function (hostId) {
      url = baseAddress + "agency/get-host" + "/" + hostId;
      return $http.get(url);
    },
    getAllUsers: function () {
      url = baseAddress + "agency/get-all-hosts";
      return $http.get(url);
    },
...
app.controller(
  ...
  function PostController(
    ...
    $scope.getAdmin = function () {
      A_dashboardFactory.getLocationDetails()
        .success(function (data) {
          console.log(data.status);
          $scope.city = data.city;
          $scope.state = data.regionName;
          $scope.zip = data.zip;
          $scope.location = `[${data.lat}, ${data.lon}]`;
        })
        .error(function (data) {
      ...
      A_dashboardFactory.getAllUsers()
        .success(function (data) {
          if (data.success) {
            ...
            $scope.allUsers = data.data.results;
    ...
    $scope.addUser = function (user) {
      ...
      user.agencyId = $scope.profile.user;
      console.log(user);
    ...
    $scope.assignUser = function (user) {
      console.log("user", user);
      A_dashboardFactory.assignUserDetails(user).success(function (data) {
        console.log("data", data);
        if (data.success == true) {
          Notification.success(data.data.msg);
          $scope.getAdmin();
