...
app.factory("A_dashboardFactory", function ($http, $window) {
  return {
    ...
    blockUnblockUser: function (data) {
      url = baseAddress + "user/block-unblock";
      return $http.post(url, data);
    },

    deleteUser: function (data) {
      url = baseAddress + "user/delete";
      return $http.post(url, data);
    },
...
app.controller(
  ...
  function PostController(
    ...
    $scope.getAdmin = function () {
      A_dashboardFactory.getUserDetails()
    ...
    $scope.verifyStatus = function (is, status) {
      console.log("is", is);
    ...
    // Recommend
    $scope.recommend = function (id, status) {
      console.log("id", id);
      console.log("status", status);
    ...
    // Block/Unblock
    $scope.blocked = function (id, status) {
      console.log("id", id);
      console.log("status", status);
      ...
      A_dashboardFactory.blockUnblockUser(formdata).success(function (data) {
        console.log("data", data);
    ...
    $scope.delete = function (id) {
      ...
      A_dashboardFactory.deleteUser(formdata).success(function (data) {
        console.log("data", data);
    ...
    // verify Email
    $scope.verifyEmail = function (id, status) {
      console.log("id", id);
      console.log("status", status);
    ...
    // Recommend
    $scope.verifyPhone = function (id, status) {
      console.log("id", id);
      console.log("status", status);
