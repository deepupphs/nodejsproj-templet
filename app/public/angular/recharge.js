...
app.factory("A_dashboardFactory", function ($http, $window) {
  return {
    addUserDetails: function (data) {
      url = baseAddress + "add-recharge";
      return $http.post(url, data);
    },
    getSingleDetails: function (id) {
      url = baseAddress + "get-recharge" + "/" + id;
      return $http.get(url);
    },
    getAllUsers: function () {
      url = baseAddress + "get-all-recharges";
      return $http.get(url);
    },

    updateRechargeDetails: function (data) {
      url = baseAddress + "update-recharge";
      return $http.post(url, data);
    },

    deleteRechargeDetails: function (data) {
      url = baseAddress + "delete-recharge";
      return $http.post(url, data);
    },
  };
});
...
app.controller(
  ...
  function PostController(
      ...
      A_dashboardFactory.getAllUsers()
        .success(function (data) {
          if (data.success) {
            ...
            $scope.allRecharges = data.data.results;
            console.log("allRecharges", $scope.allRecharges);
          } else {
            Notification.error({
    ...
    // Update charge
    $scope.updateRecharge = function (user) {
      console.log("user", user);
      A_dashboardFactory.updateRechargeDetails(user).success(function (data) {
        console.log("data", data);
        if (data.success == true) {
          Notification.success(data.data.msg);
          $scope.getAdmin();
    ...
    // delete charge
    $scope.deleteRecharge = function (user) {
      let toDelete = { id: user._id };
      console.log("Chanrge delete", toDelete);
      A_dashboardFactory.deleteRechargeDetails(toDelete).success(function (
        data
      ) {
        console.log("data", data);
        if (data.success == true) {
