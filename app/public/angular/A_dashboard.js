...
app.factory("A_dashboardFactory", function ($http, $window) {
  return {
    getChartData: function () {
      url = baseAddress + "get-chart-data";
      return $http.get(url);
    },
  };
});
      ...
      A_dashboardFactory.getChartData()
        .success(function (data) {
          if (data.success) {
            ...
            $scope.totalUsersCount = data.data.results.totalUsersCount;
            $scope.totalMaleCount = data.data.results.totalMaleCount;
            $scope.totalFemaleCount = data.data.results.totalFemaleCount;
            ...
            $scope.pieChartData = [
              $scope.totalMaleCount,
              $scope.totalFemaleCount - $scope.totalHostCount,
              $scope.totalHostCount,
            ];
            ...
            var myChart3 = new Chart(ctx3, {
              ...
              data: {
                ...
                labels: ["Males", "Hosts-Pending", "Hosts-Approved"],
              },
              options: {
                responsive: true,
                layout: {
